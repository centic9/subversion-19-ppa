...
/*@SWIG:/home/evgeny/release/svnrm/1.9.3/prefix/share/swig/2.0.12/ruby/rubyprimtypes.swg,19,%ruby_aux_method@*/
...
_wrap_svn_repos_fs_change_rev_prop4(int argc, VALUE *argv, VALUE self) {
  ...
  arg4 = (char *)(buf4);
  res5 = SWIG_ConvertPtr(argv[4], &argp5,SWIGTYPE_p_p_svn_string_t, 0 |  0 );
  if (!SWIG_IsOK(res5)) {
    SWIG_exception_fail(SWIG_ArgError(res5), Ruby_Format_TypeError( "", "svn_string_t const *const *","svn_repos_fs_change_rev_prop4", 5, argv[4] )); 
  }
