...
XS(_wrap_svn_txdelta_send_stream) {
  {
    ...
    {
      /*@SWIG:/home/evgeny/release/svnrm/1.9.3/prefix/share/swig/2.0.12/perl5/perltypemaps.swg,59,%append_output@*/ if (argvi >= items) EXTEND(sp,1); /*@SWIG:/home/evgeny/release/svnrm/1.9.3/prefix/share/swig/2.0.12/perl5/perltypemaps.swg,56,%set_output@*/ ST(argvi) = sv_2mortal(newSVpv(svn_md5_digest_to_cstring(arg4,
            _global_pool),
          0)); argvi++ /*@SWIG@*/
...
XS(SWIG_init) {
  ...
  /*@SWIG:/home/evgeny/release/svnrm/1.9.3/prefix/share/swig/2.0.12/perl5/perltypemaps.swg,65,%set_constant@*/ do {
